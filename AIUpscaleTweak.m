...
//   - Every hook body is wrapped defensively and falls back to passthrough
//     behavior on failure rather than propagating, since a single bad
//     frame should never be able to take down the host app. That said,
//     @try/@catch only catches Objective-C NSExceptions — it can't save you
//     from a true low-level memory fault, so "defensive" reduces risk, it
